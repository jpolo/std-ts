...
const __constructor = function (o: Vector4): Vector4Constructor { return o.constructor || Float64Array; };
const __arrayCreate = function (Constructor: Vector4Constructor): Vector4 {
  return new Constructor(4);
};
const __arrayCreateFrom = function (o: Vector4) {
  return __arrayCreate(__constructor(o));
};
const __arrayCopy = function (src: Vector4, dest: Vector4) {
  if (src !== dest) {
    dest[0] = src[0];
    dest[1] = src[1];
    dest[2] = src[2];
...
const __arrayFill = function (a: Vector4, v: number) {
  a[0] = v;
  a[1] = v;
  a[2] = v;
  a[3] = v;
