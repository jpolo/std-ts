module vector2 {
  ...
  var __constructor = function (o: Vector2): Vector2Constructor { return o.constructor || Float64Array; };
  var __arrayCreate = function (Constructor: Vector2Constructor): Vector2 {
    return new Constructor(2);
  };
  var __arrayCreateFrom = function (o: Vector2) {
    return __arrayCreate(__constructor(o));
  };
  var __arrayCopy = function (src: Vector2, dest: Vector2) {
    if (src !== dest) {
      dest[0] = src[0];
      dest[1] = src[1];
    }
  };
  var __arrayFill = function (a: Vector2, v: number) {
    a[0] = v;
    a[1] = v;
  };
