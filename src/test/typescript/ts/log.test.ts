...
const MessageSuite = suite('ts/log.Message', (self) => {
  ...
  test('#constructor()', (assert) => {
    const m = new Message(DEBUG, 'mygroup', ['mymessage'])
  ...
  test('#equals()', (assert) => {
    const message = new Message(DEBUG, 'mygroup', ['mymessage'])
...
const LevelSuite = suite('ts/log.Level', () => {
  ...
  test('#compare()', (assert) => {
    const level = new Level('BLAH', DEBUG.value, PRIVATE_KEY)
